  ...
  return (
    <>
      <div className="p-2 space-x-2" style={{ backgroundColor: '#D7D2CB' }}>
        ...
        <Button variant="primary-inverted" size='lg'>Button</Button>
        <Button variant="secondary-inverted" size='lg'>Button</Button>
      </div>
      <div className="p-2 space-x-2" style={{ backgroundColor: '#D7D2CB' }}>
      ...
      <div className="p-2 space-x-2" style={{ backgroundColor: '#D7D2CB' }}>
        ...
        <Button variant="primary-inverted" size='sm'>Button</Button>
        <Button variant="secondary-inverted" size='sm'>Button</Button>
      </div>
      <div className="p-2 space-x-2" style={{ backgroundColor: '#D7D2CB' }}>
        <Button size='xs'>Button</Button>
        <Button variant="secondary" size='xs'>Button</Button>
        <Button variant="tertiary" size='xs'>Button</Button>
        <Button variant="primary-inverted" size='xs'>Button</Button>
        <Button variant="secondary-inverted" size='xs'>Button</Button>
      </div>
